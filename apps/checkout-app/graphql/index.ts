...
export function useFileUploadMutation() {
  return Urql.useMutation<FileUploadMutation, FileUploadMutationVariables>(
    FileUploadDocument
  );
}
...
export function usePublicMetafieldsQuery(
  ...
  return Urql.useQuery<PublicMetafieldsQuery>({
...
export function usePrivateMetafieldsQuery(
  ...
  return Urql.useQuery<PrivateMetafieldsQuery>({
...
export function useOrderDetailsQuery(
  ...
  return Urql.useQuery<OrderDetailsQuery>({
