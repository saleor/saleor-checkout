...
export type MetadataItemFragment = {
  __typename?: "MetadataItem";
  key: string;
  value: string;
};
...
export type PrivateMetadataQuery = {
  __typename?: "Query";
  app?: {
    __typename?: "App";
    id: string;
...
export type PublicMetadataQuery = {
  __typename?: "Query";
  app?: {
    __typename?: "App";
    id: string;
...
export function useChannelQuery(
  options: Omit<Urql.UseQueryArgs<ChannelQueryVariables>, "query">
) {
...
export function usePrivateMetadataQuery(
  options: Omit<Urql.UseQueryArgs<PrivateMetadataQueryVariables>, "query">
) {
  return Urql.useQuery<PrivateMetadataQuery>({
    query: PrivateMetadataDocument,
    ...options,
  });
}
...
export function usePublicMetadataQuery(
  options: Omit<Urql.UseQueryArgs<PublicMetadataQueryVariables>, "query">
) {
  return Urql.useQuery<PublicMetadataQuery>({
    query: PublicMetadataDocument,
    ...options,
  });
}
...
export function useOrderCreateMutation() {
  return Urql.useMutation<OrderCreateMutation, OrderCreateMutationVariables>(
    OrderCreateDocument
  );
}
...
export function useOrderTransactionsQuery(
  ...
  return Urql.useQuery<OrderTransactionsQuery>({
